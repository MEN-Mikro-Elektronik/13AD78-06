 ...
 *
 * $Log: ad78_ctrl.c,v $
 * Revision 1.4  2009/08/31 14:35:47  MRoth
 * R: Porting to MDIS5
 * M: added support for 64bit (MDIS_PATH)
 *
 * Revision 1.3  2009/04/23 17:31:45  ts
 * R: build of windows package (-70) failed
 * M: added specifier __MAPILIB for Signal Handler function
 *
 * Revision 1.2  2006/07/21 10:09:25  DPfeuffer
 * cosmetics
 *
 * Revision 1.1  2006/05/26 15:06:37  DPfeuffer
 * Initial Revision
 *
 *---------------------------------------------------------------------------
